...
export const imageArray3 = [
  {
    alt: "Image 1",
    src: "https://www.waylead.org/assets/images/properties/le-jardin-symphonique/hero-01.jpg",
  },
  {
    alt: "Image 2",
    src: "https://www.waylead.org/assets/images/properties/le-jardin-symphonique/hero-02.jpg",
  },
  {
    alt: "Image 3",
    src: "https://www.waylead.org/assets/images/properties/le-jardin-symphonique/hero-03.jpg",
  },
  {
    alt: "Image 4",
    src: "https://www.waylead.org/assets/images/properties/le-jardin-symphonique/hero-04.jpg",
  },
];
  ...
  "January 2025": [
    {
      ...
      images: ["/766.jpg", "/apar.jpg", "/apart.jpg"],
    },
    {
      title: "Gambia: A Tourist Destination and Green Field for Real Estate",
      date: "January 15, 2025",
      ...
      images: ["/property/33.jpeg", "/property/34.jpeg", "/property/35.jpeg"],
    },
  ],
  "February 2025": [
    {
...
export const propertiy = [
  {
    ...
    garage: 1,
    amenities: [
      { label: "Swimming Pool", icon: <FaWater /> },
      { label: "Gym", icon: <Dumbbell /> },
      { label: "Security System", icon: <ShieldCheck /> },
      { label: "Balcony", icon: <Building2 /> },
      { label: "Smart Home", icon: <Home /> },
      {
        label: "Floor-to-ceiling windows with panoramic city views",
        icon: <PaintRollerIcon />,
      },
      { label: "Open-concept living area", icon: <Layout /> },
      { label: "Quartz countertops and hardwood flooring", icon: <Sparkles /> },
      { label: "Master suite with walk-in closet", icon: <KeyRound /> },
      { label: "Spa-like bathroom with heated floors", icon: <Bath /> },
      { label: "24/7 concierge service", icon: <ConciergeBell /> },
      { label: "Rooftop lounge", icon: <Home /> },
    ],
    image: [
      "/property/p1.jpeg",
      "/property/p2.jpeg",
  ...
  },
  {
    ...
    amenities: [
      ...
      { label: "Balcony", icon: <Building2 /> },
      { label: "Smart Home", icon: <Home /> },
      { label: "Panoramic Views", icon: <MountainSnow /> },
      { label: "Open-concept Living", icon: <Layout /> },
      { label: "Quartz Countertops", icon: <Sparkles /> },
      { label: "Walk-in Closet", icon: <KeyRound /> },
      { label: "Heated Bathroom Floors", icon: <Bath /> },
      { label: "24/7 Concierge", icon: <ConciergeBell /> },
      { label: "Rooftop Lounge", icon: <Home /> },
    ],
    image: [
      "/property/p10.jpeg",
  ...
  //     monthly: "D65,000",
  //   },
  //   title: "Affordable Suburban Bungalow",
  ...
  //   garage: 1,
  //   amenities: [
  //     { label: "Backyard", icon: <TreePine /> },
  //     { label: "Patio", icon: <Sun /> },
  //     { label: "Fireplace", icon: <Flame /> },
  //     { label: "Energy Efficient", icon: <Leaf /> },
  //     { label: "Storage Shed", icon: <Warehouse /> },
  //     { label: "Spacious backyard with patio", icon: <Trees /> },
  //     { label: "Fireplace in living room", icon: <FireExtinguisher /> },
  //     { label: "Energy-efficient windows", icon: <SunDim /> },
  //     { label: "Modern kitchen appliances", icon: <Microwave /> },
  //     {
  //       label: "Quiet neighborhood close to schools and parks",
  //       icon: <School />,
  //     },
  //   ],
  //   image: [
  ...
  //   description:
  //     "This cozy newly built bungalow in Brufut Heights offers affordable luxury for small families or couples. The house includes 2 well-lit bedrooms, 1 bathroom, an open-plan living and dining space, and a functional kitchen. Enjoy outdoor living with a private patio and fenced compound for security and privacy. Just minutes from the beach and local amenities.",
  // },

  {
    ...
    description: `Diplomatic in Bijilo after Aqua View and Coco Ocean Hotel offers a blend of luxury and comfort. Located in one of the prime residential areas, this property features spacious en-suite bedrooms, a fully equipped modern kitchen, a sea-view living area, landscaped garden, large swimming pool, and top-notch security.`,
    amenities: [
      {
        label: "2 Spacious Bedrooms with en-suite bathrooms",
        icon: <BedDouble />,
      },
      { label: "Fully equipped modern kitchen", icon: <Utensils /> },
      { label: "Sea view living and dining areas", icon: <PanelTopOpen /> },
      { label: "Landscaped garden 🪴", icon: <Flower2 /> },
      { label: "Large swimming pool", icon: <FaWater /> },
      { label: "Ample car parking spaces", icon: <ParkingSquare /> },
      { label: "CCTV security and guards", icon: <ShieldCheck /> },
      { label: "Less than a minute walk to the ocean 🌊", icon: <Waves /> },
    ],
  },
];
