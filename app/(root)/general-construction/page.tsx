...
const page = () => {
    return (
        <div className='mb-[5%]'>
            ...
            <ConstructionCategory title={"Assets Management"} />
            <FeatureSection
                title="Do you want to manage your assets?"
                imageSrc="https://standardhomesgambia.com/wp-content/uploads/2024/12/two-happy-dark-skinned-businessmen-reading-documents-with-magnifying-glass_273609-9168.jpg"
                imageAlt="Assets"
            ...
            />
            <ConstructionCateory2 title={"Architectural Design"} />
            <FeatureSection2
                title="Are you starting a construction?"
                imageSrc="https://standardhomesgambia.com/wp-content/uploads/2024/12/blog-details-2.jpg"
            ...
            />
            <ConstructionCategory title={"Commercial & Residential Construction"} />
            <FeatureSection
                title="Need a reliable construction partner?"
                imageSrc="https://standardhomesgambia.com/wp-content/uploads/2024/12/african-american-worker-standing-uniform-wearing-safety-hat-factory_1303-30606.jpg"
                imageAlt="commerce"
            ...
            />
            <ConstructionCateory2 title={"Construction Project Management"} />
            <FeatureSection2
                title="Don't know where to kickoff your project?"
                imageSrc="https://standardhomesgambia.com/wp-content/uploads/2024/12/construction-project-management-2.jpg"
                imageAlt="Engineer"
            ...
            />
            <ConstructionCategory title={"Interior Decoration"} />
            <FeatureSection
                title="We excel in sleek interior designs"
                imageSrc="https://standardhomesgambia.com/wp-content/uploads/2024/12/Top-Interior-Design-Trends-to-Design-Your-Dream-Home_804646102d455.jpg"
                imageAlt="Interior"
